...
import { SERVICE_CATALOG_SECTIONS, SERVICES_CATALOG } from "@/lib/data";
      ...
      <section className="bg-[#0B0F19] text-white py-16 border-b border-[#D4AF37]/30 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-4">
          ...
          <p className="text-gray-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed font-normal">
            Structured financing, mortgage syndication, real-asset acquisitions, and financial planning designed around your goals.
          </p>
        </div>
      </section>
